...
export default function LoginPage() {
  ...
  return (
    <div className="h-screen w-screen bg-white flex p-3 sm:p-4 gap-4 sm:gap-6 overflow-hidden text-slate-800 font-sans selection:bg-red-500 selection:text-white">
      ...
      {/* Left Hero Card Frame - Matching JECRC Rounded Image Frame */}
      <div className="flex-1 relative h-full rounded-[24px] overflow-hidden bg-slate-100 border border-slate-200/80 shadow-xs flex flex-col justify-between p-4 group">
        {/* Main Campus Image */}
        <img
          src={campusImage.src}
      ...
      {/* Right Login Panel - Matches exact JECRC CSS (430px width, padding 1rem 2.5rem) */}
      <aside
        className="w-full sm:w-[430px] shrink-0 h-full bg-white flex flex-col justify-between py-2 px-6 sm:px-10 overflow-y-auto"
        style={{
