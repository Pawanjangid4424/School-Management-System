  ...
  return (
    <>
      ...
      <div className="hidden md:flex md:flex-1 relative h-full rounded-[24px] overflow-hidden bg-slate-100 border border-slate-200/80 shadow-xs flex-col justify-between p-4 group">
        ...
        {/* Red School Badge overlay at bottom left */}
            ...
            <div className="relative">
              ...
              <div className="relative flex items-center">
                <input
                  ...
                  className="w-full rounded-[4px] border border-slate-300 bg-white px-3 py-2 text-xs sm:text-sm text-slate-900 font-medium placeholder:text-slate-400 focus:border-red-600 focus:bg-white focus:outline-none transition-all pr-9 h-10"
                />
          ...
          <div className="border-t border-slate-100 pt-3 space-y-1.5 shrink-0">
            ...
            <div className="flex justify-center">
              <button
                ...
                className="w-full py-1.5 px-4 rounded-lg border border-red-200 bg-red-50/60 hover:bg-red-100 hover:border-red-300 text-red-700 text-xs font-semibold transition-all text-center flex items-center justify-center gap-1.5 shadow-xs cursor-pointer"
              >
