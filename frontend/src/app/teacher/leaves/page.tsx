        ...
        <main className="px-4 md:px-8 py-6 max-w-[1600px] mx-auto w-full space-y-6">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-4 gap-4">
            ...
            <div className="rounded-xl border border-amber-200 bg-amber-50/50 p-4 shadow-2xs flex items-center gap-3">
              ...
              <div>
                <span className="text-xs text-amber-800 font-medium">Pending Action</span>
              ...
              <table className="w-full text-left text-xs">
                <thead className="bg-slate-50/90 text-slate-500 border-b border-slate-200 font-bold uppercase tracking-wider">
                  <tr>
                    ...
                    <th className="px-6 py-4 min-w-[280px]">Reason</th>
                        ...
                        <tr key={req.id} className="hover:bg-slate-50/70 transition-colors group">
                          <td className="px-6 py-4 font-medium text-slate-900">
                            <div className="flex items-center gap-3">
                              <div className="h-9 w-9 rounded-full bg-indigo-100 text-indigo-900 flex items-center justify-center font-bold text-xs shrink-0 border border-indigo-200">
                          ...
                          <td className="px-6 py-4">
                            <div
                              ...
                              className="group-hover:border-indigo-300 rounded-lg border border-slate-200/80 bg-slate-50/60 p-2.5 text-xs text-slate-700 cursor-pointer hover:bg-indigo-50/40 transition-all flex items-start gap-2 max-w-md"
                            ...
                            >
                              ...
                              <div className="flex-1 min-w-0">
                                ...
                                <span className="text-[10px] text-indigo-700 font-semibold mt-1 inline-flex items-center gap-1 group-hover:underline">
          ...
          <div className="fixed inset-0 z-50 flex items-center justify-center bg-slate-950/50 backdrop-blur-xs p-4">
            ...
            >
              <div className="flex justify-between items-start border-b border-slate-100 pb-4">
                <div className="flex items-center gap-3">
                  <div className="h-10 w-10 rounded-full bg-indigo-100 text-indigo-900 flex items-center justify-center font-bold text-sm border border-indigo-200 shrink-0">
              ...
              <div className="space-y-1.5">
                ...
                <div className="rounded-xl border border-indigo-200 bg-indigo-50/40 p-4 text-xs leading-relaxed text-slate-900 font-normal shadow-2xs whitespace-pre-wrap">
