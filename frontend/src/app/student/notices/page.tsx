...
import { Bell, Mail, Megaphone, CheckCircle2, RefreshCw, Sliders, Save, Sparkles, Pin, BookOpen } from 'lucide-react';
    ...
    return (
      <div className="flex h-screen w-screen items-center justify-center bg-slate-900 text-white text-sm font-medium">
        <div className="flex items-center gap-3">
          ...
          <span>Loading School Notices & Alerts...</span>
        </div>
      </div>
    );
  }
  ...
  return (
    <div className="flex min-h-screen bg-slate-50 selection:bg-slate-900 selection:text-white">
      ...
      <div className="flex-1 pl-0 md:pl-64 transition-all duration-300 min-w-0">
        <Topbar
          title="Student Notices & Notification Settings"
          userName="Welcome, Student"
          ...
          <div className="bg-gradient-to-r from-slate-900 via-slate-800 to-indigo-950 rounded-2xl p-6 text-white shadow-xl flex flex-col md:flex-row md:items-center justify-between gap-6 border border-slate-800">
            <div className="space-y-1.5">
              ...
              <h2 className="text-2xl sm:text-3xl font-bold tracking-tight text-white">
                School Notices & Notification Alerts
              </h2>
              <p className="text-xs sm:text-sm text-slate-300 max-w-xl">
                Read official school announcements, upcoming exam dates, assignment postings, and manage notification preferences.
              </p>
            </div>
            ...
            <div className="space-y-4">
              {notices.length === 0 ? (
                <div className="bg-white rounded-2xl border border-slate-200/80 p-12 text-center text-slate-400">
                  ...
                  <p className="text-xs text-slate-400">You are up to date with official school notices.</p>
                </div>
              ) : (
                notices.map((n) => (
                  <div
          ...
          {activeTab === 'settings' && (
            <div className="bg-white rounded-2xl border border-slate-200/80 shadow-sm p-6 space-y-6">
              <div className="flex items-center gap-2.5 border-b border-slate-100 pb-3">
                ...
                <div>
                  <h3 className="text-base font-bold text-slate-900">Student Notification Preferences</h3>
                  <p className="text-xs text-slate-500">Customize alerts for new homework, exam timetables, and school notices.</p>
                </div>
              </div>
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
                ...
                >
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      <span className="text-xs font-bold text-slate-900 block">New Coursework Alerts</span>
                      <span className="text-[10.5px] text-slate-500">Homework postings</span>
                    </div>
                  </div>
                  <input type="checkbox" checked={settings.assignmentAlerts} onChange={() => {}} className="h-4 w-4 rounded border-slate-300 text-slate-900" />
                </div>
                ...
                >
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      <span className="text-xs font-bold text-slate-900 block">Notice Board Alerts</span>
                      <span className="text-[10.5px] text-slate-500">School circulars</span>
                    </div>
                  </div>
                  <input type="checkbox" checked={settings.noticeAlerts} onChange={() => {}} className="h-4 w-4 rounded border-slate-300 text-slate-900" />
                </div>
